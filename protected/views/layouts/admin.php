...
<head>
    ...
    <link href="/assets/admin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    ...
    <script type="text/javascript" src="/assets/admin/js/index.js"></script>

</head>

<body class="fixed-sidebar full-height-layout gray-bg">
<div id="wrapper">
    <?php $this->beginWidget('application.widget.common.adminLeft'); ?>
    <?php $this->endWidget(); ?>
